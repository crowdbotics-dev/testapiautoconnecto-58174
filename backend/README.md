...
## Project Structure
    ...
    ├── testapiautoconnecto_58174  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_58174`
...
2. Clone this repo and `cd testapiautoconnecto_58174`
